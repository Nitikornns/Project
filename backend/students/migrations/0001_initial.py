    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work', to='students.student')),
            ],
            options={
                'ordering': ['workid'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('studentname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='picture', to='students.student')),
            ],
            options={
                'ordering': ['pictureid'],
            },
